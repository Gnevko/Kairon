 ...
 * {@code SquadronCreated} journal event.
 *
 * @see <a href="https://hosting.zaonce.net/community/journal/v37/Journal_Manual_v37.pdf">
 * Frontier Player Journal Manual v37, section 10.8</a>
 */
public record SquadronCreated(RawJournalData raw)
        implements LlmPresentableJournalEvent {

    public static final String EVENT_TYPE = "SquadronCreated";
    ...
    public LlmEventPresentation llmPresentation() {
        ...
        String sentence = "The player created squadron "
                + squadron
                + (facts.isEmpty()
                ? "."
                : ", with "
