 ...
 * {@code DockingTimeout} journal event.
 *
 * @see <a href="https://hosting.zaonce.net/community/journal/v37/Journal_Manual_v37.pdf">
 * Frontier Player Journal Manual v37, section 4.7</a>
 */
public record DockingTimeout(RawJournalData raw)
        implements LlmPresentableJournalEvent {

    public static final String EVENT_TYPE = "DockingTimeout";
    ...
    public LlmEventPresentation llmPresentation() {
        ...
        String sentence = "The player's docking request at "
                + station
                + " timed out"
                + (facts.isEmpty()
                ? "."
